                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.students.update', $student->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="cne" class="block mt-1 w-full" type="text" name="cne" :value="old('cne', $student->student->cne ?? '')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="sector" class="block mt-1 w-full" type="text" name="sector" :value="old('sector', $student->student->sector ?? '')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="city" class="block mt-1 w-full" type="text" name="city" :value="old('city', $student->student->city ?? '')" required />
